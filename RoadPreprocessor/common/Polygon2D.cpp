...
void Polygon2D::translate(float x, float y) {
	...
	boost::geometry::strategy::transform::translate_transformer<float, 2, 2> translate(x, y);
...
void Polygon2D::rotate(float angle) {
	...
	boost::geometry::strategy::transform::rotate_transformer<boost::geometry::degree, float, 2, 2> rotate(angle);
