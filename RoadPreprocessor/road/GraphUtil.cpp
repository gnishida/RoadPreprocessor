...
/**
 * Return the distance from the point to the edge.
 */
...
/**
 * Check if v1 and v2 are neighbor
 */
...
/**
 * Check the road type.
 * Example: type = 3 represents the road type of local street and avenue.
 *          type = 0 represetns all the types.
 */
...
/**
 * Convert the road graph to cv::Mat
 */
...
/**
 * Generate an image of road segments.
 * brightness: [0, 255]
 */
